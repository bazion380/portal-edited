...
/**
 * Converts a database sequence integer (e.g., 55646 or 101) into Base36,
 * left-pads it to 6 characters, and prefixes with "BMI".
 * Example: 55646 -> "BMI0016UQ"
 */
...
/**
 * Extracts a short 2-3 letter program code from a full program title.
 * Examples:
 * - "B.Sc. Computer Science" -> "CS"
 * - "B.Sc. Data Science & AI" -> "DS"
 * - "B.A. Business Administration" -> "BBA"
 * - "B.Eng. Embedded Systems" -> "ENG"
 */
...
/**
 * Determines the academic career level from the program title.
 */
...
/**
 * Generates the career-based registration number according to the formula:
 * Format: BMI/{Career}-{ProgramCode}/{ShortYear}/{Serial}
 * Example: BMI/UG-CS/226/001
 * 
 * ShortYear: "2" + last 2 digits of admission year (2026 -> "226")
 * Serial: Zero-padded 3-digit counter per program+year
 */
